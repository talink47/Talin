...
VALUES (1, 50000, '2013-12-23', '2013-12-25');
													...
													-- insert 2nd row values 

-- Insert values into the employees table
INSERT INTO employees (birth_date, first_name, last_name, gender, hire_date)
VALUES ('2005-03-28', 'Talin', 'K P', 'M', '2024-05-14');

-- Insert values into the departments table
INSERT INTO departments (dept_no, dept_name) 
VALUES ('c001', 'Cse department');

-- Insert values into the dept_emp table
INSERT INTO dept_emp (emp_no, dept_no, from_date, to_date)
VALUES (2, 'c001', '2024-05-14', '2024-06-14');

-- Insert values into the dept_manager table
INSERT INTO dept_manager (dept_no, emp_no, from_date, to_date)
VALUES ('c001', 2, '2024-05-14', '2024-06-14');

-- Insert values into the titles table
INSERT INTO titles (emp_no, title, from_date, to_date)
VALUES (2, 'Manager', '2024-05-14', '2024-06-14');

-- Insert values into the salaries table
INSERT INTO salaries (emp_no, salary, from_date, to_date)
VALUES (2, 60000, '2024-05-14', '2024-06-14');

					                                         -- inserting 3rd values

-- Insert values into the employees table
INSERT INTO employees (birth_date, first_name, last_name, gender, hire_date)
VALUES ('2004-07-01', 'Bhava', 'Sree', 'F', '2024-05-15');

-- Insert values into the departments table
INSERT INTO departments (dept_no, dept_name) 
VALUES ('m002', 'mech department');

-- Insert values into the dept_emp table
INSERT INTO dept_emp (emp_no, dept_no, from_date, to_date)
VALUES (3, 'm002', '2024-05-15', '2024-06-15');

-- Insert values into the dept_manager table
INSERT INTO dept_manager (dept_no, emp_no, from_date, to_date)
VALUES ('m002', 3, '2024-05-15', '2024-06-15');

-- Insert values into the titles table
INSERT INTO titles (emp_no, title, from_date, to_date)
VALUES (3, 'Assistant Manager', '2024-05-15', '2024-06-15');

-- Insert values into the salaries table
INSERT INTO salaries (emp_no, salary, from_date, to_date)
VALUES (3,40000, '2024-05-15', '2024-06-15');
...
UPDATE employees SET first_name='karthick' WHERE emp_no=1;

												-- deleting values rows and tables 
...
SELECT * FROM employees WHERE first_name = 'Talin' AND last_name = 'K P';

-- Sort the table with conditions using OR keyword
SELECT * FROM employees WHERE gender = 'M' OR hire_date = '2024-05-14';

-- Use NOT keyword
SELECT * FROM salaries WHERE NOT salary = 50000;
...
SELECT COUNT(*) FROM employees WHERE gender = 'F';
                                                      ...
                                                      -- DELETE FROM employees WHERE emp_no=2; "DOUT"

-- Use SUM() function
SELECT SUM(salary) FROM salaries;
SELECT SUM(salary) FROM salaries WHERE from_date = '2013-12-23';

-- Use AVG() function
SELECT AVG(salary) FROM salaries;
SELECT AVG(salary) FROM salaries WHERE from_date = '2013-12-23';

-- Use LIKE operator
SELECT * FROM employees WHERE first_name LIKE 'T%';

-- Use IN operator
SELECT * FROM salaries WHERE salary IN (40000, 50000);
SELECT * FROM salaries WHERE salary NOT IN (40000, 50000);

-- Use BETWEEN operator
SELECT * FROM salaries WHERE salary BETWEEN 40000 AND 60000;
SELECT * FROM salaries WHERE salary NOT BETWEEN 40000 AND 60000;
...
-- Exists keyword
SELECT first_name,salary FROM employees, salaries WHERE EXISTS (SELECT salary FROM salaries WHERE salaries.emp_no = employees.emp_no AND salary > 40000);
...
CREATE TABLE employee_details (
    ...
    mobile_num INT(32) 		NOT NULL 		DEFAULT 0000000000,
    age 	   INT,
    CHECK (age > 18)
);

-- Insert values into the employee_details
INSERT INTO  employee_details (emp_no, mobile_num , age)
VALUES (4,'98765','19');
...
ALTER TABLE  employee_details DROP COLUMN mobile_num;
